...
function custom_dashboard_help()
{
    ...
    $edit_text_tutorial_url = get_stylesheet_directory_uri() . '/media/edit-text.mp4';
    ...
    echo '<p>Watch the video below to learn how to edit text (like bolding or italicizing):</p>';
    echo '<video width="560" height="315" controls>
            <source src="' . esc_url($edit_text_tutorial_url) . '" type="video/mp4">
            Your browser does not support the video tag.
        </video>';
}
